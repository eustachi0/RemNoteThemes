...
- Version 1.1
- Released date: 10-June 2021.
	```markdown
	# RemNote Dark Theme by eustachio v1.1 ##Todo
	 - Designed, created and maintained by Eustachio
	 - This theme has been created to work with the `Dark Mode ON`
	 - This is something I do for fun as I like simple and modern UI's. I wanted to make RemNote look awesome!!!
	 - Version 1.01 - Released date: 10 June 2021
	 ...
	 ## 10 Checkbox ##Todo
		...
		.ui.checkbox input:checked~.box:before, .ui.checkbox input:checked~label:before {
				...
				border-color: rgb(50, 58, 72)!important;
		}
		.ui.checkbox input:checked~.box:after, .ui.checkbox input:checked~label:after {
				color: rgb(50, 58, 72)!important;
		}
		```
	 ## 11 Code block ##Todo
		```css
