...
- # RemNote Dark Theme by eustachio ##Todo
	...
	- ## 0 Variables ##Todo
		- [ ] **General customizations**
			...
			:root {
			/*body*/
				--body-background-color: rgb(35, 38, 38);
				...
				--blackout-background-color: rgb(43, 46, 46);
			...
			/*Focused rem*/
				...
				--quote-background: var(--accent-color);
				--focused-quote-background: var(--focused-accent-color);
				...
				--search-box-background-color: rgb(27, 30, 30);
				--search-box-text-color: var(--body-text-color);

			/*sidebar*/
				--sidebar-top-background-color: rgb(30, 33, 33);
				--sidebar-background-color: rgb(30, 33, 33);
				--sidebar-text-color: #BFBFBF;
				--sidebar-hover-background-color: rgb(39, 42, 42);
				--sidebar-hover-text-color: #D8D8D8;
				--nodocuments-text-color: rgb(87, 90, 90);
				--queue-indicator-icon-color: orange;
				--sidebar-focused-background-color: rgb(47, 50, 50);
				--sidebar-focused-left-border-color: rgb(47, 50, 50);
				--sidebar-focused-left-border-width: 0px;
				--sidebar-focused-text-color: white;
				--bars-border-color: rgb(52, 55, 55);
			...
			/* popups */
				--popup-background-color: rgb(40, 43, 43);
				--popup-text-color: var(--body-text-color);
				--popup-hover-background-color: rgb(55, 58, 58);
				--popup-hover-text-color: var(--body-text-color);
				--popup-border-radius: 6px;

				--popup-border-color: rgb(50, 53, 53);
			...
			/* scrollbar color*/
				...
				--scrollbar-hover-color: rgb(55, 58, 58);

			/* toggle checkbox*/   
				--toggle-background-color: rgb(53, 55, 55);
				--toggle-color: #CECECE;

			/* knowledge base page*/
				--knowledgebasepage-background-color: rgb(39, 42, 42);
				--knowledgebasepage-title-background-color: rgb(47, 50, 50);

			/*portals*/
				--portal-background-color: rgb(42, 45, 45);
				--portal-text-color: #C4C4C4;
				--embeddedsearch-background-color: rgb(39, 42, 42);
				--portal-border-color: rgb(42, 45, 45);
				--portal-inside-portal-border-color: rgb(52, 55, 55);
			...
			/* code block */
				...
				--code-block-background-color: rgb(27, 30, 30);
				--code-block-focused-background-color: rgb(22, 25, 25);
	...
	- ## 1 Body ##Todo
		...
		.gutter:hover {
			background-color: var(--bars-border-color);
			max-width: 2px!important;
		}
	...
	- ## 2 Scrollbars ##Todo
		...
		/* Sidebar */
		#main #content #document-sidebar ::-webkit-scrollbar-thumb {
			background-color: var(--scrollbar-color) !important;
			border: 4px solid;
		...
		#main #content #document-sidebar ::-webkit-scrollbar-thumb:hover {
			background-color: var(--scrollbar-hover-color) !important;
			border: 4px solid;
			border-color: var(--sidebar-background-color);
	...
	- ## 4 Side, Bottom, Nav Bars ##Todo
		...
		.hierarchy-editor-toolbar-container--opened #hierarchy-editor-toolbar .hierarchy-editor-toolbar-item__type-icon:hover {
			-webkit-filter: var(--accent-color-filter);
			filter: var(--accent-color-filter);
		}
	...
	- ## Optionals ##Todo
		...
		- [x] **Op02 Account/Knowledge base name**
			```css
			:root {
				--sidebar-account-name: 'Name here';
